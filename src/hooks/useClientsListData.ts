...
import { clientsQuery, logDbError, profilesQuery, type PublicProfile } from "@/lib/api";
...
/**
 * Dados exclusivos da listagem de clientes. As ações chegam com apenas os
 * três campos necessários para contar abertas e vencidas por cliente.
 */
export function useClientsListData() {
  const results = useQueries({
    queries: [clientsQuery(), clientsListActionsQuery(), profilesQuery()],
  });
